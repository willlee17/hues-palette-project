export default [
  {
    paletteName: "Tyranitar",
    id: "material-ui-colors",
    emoji: "🎨",
    colors: [
      { name: "palesilver", color: "#C1CFAB" },
      { name: "pastelblue", color: "#ACC6D5" },
      { name: "richblack", color: "#050601" },
      { name: "philippinebrown", color: "#591B0C" },
      { name: "parrotpink", color: "#D9969D" },
